...
**Justificativa:**
A vaga é voltada para profissionais em início de carreira, com foco em aprendizado contínuo, desenvolvimento técnico e aplicação prática de fundamentos em ambientes reais de dados.
...
* **SQL** para consultas, joins e organização de dados
* Conceitos básicos de engenharia de dados (ETL, pipelines)
